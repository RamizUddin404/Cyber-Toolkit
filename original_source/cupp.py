...
def read_config(filename):
    ...
    if os.path.isfile(filename):
        ...
        print("\033[1;32m[*] ", end=""); print("Configuration file " + filename + " not found!")
        sys.exit("Exiting.")
    ...
    if inspect == "y":
        try:
            with open(filename, "r+") as wlist:
                ...
                for line in data:
                    print("\033[1;32m[*] ", end=""); print("\033[1;32m[" + filename + "] \033[1;33m" + line)
                    time.sleep(0000.1)
                    os.system("clear")
        except Exception as e:
            print("\033[1;32m[*] ", end=""); print("[ERROR]: " + str(e))
    else:
        pass
...
def print_cow():
    print("\033[1;32m[*] ", end=""); print(" ___________ ")
    print("\033[1;32m[*] ", end=""); print(" \033[07m  cupp.py! \033[27m                # \033[07mC\033[27mommon")
    print("\033[1;32m[*] ", end=""); print("      \\                     # \033[07mU\033[27mser")
    print("\033[1;32m[*] ", end=""); print("       \\   \033[1;31m,__,\033[1;m             # \033[07mP\033[27masswords")
    print("\033[1;32m[*] ", end=""); print("        \\  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # \033[07mP\033[27mrofiler")
    print("\033[1;32m[*] ", end=""); print("           \033[1;31m(__)    )\\ \033[1;m  ")
    print("\033[1;32m[*] ", end=""); print("           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Muris Kurgas | j0rgan@remote-exploit.org ]")
    print("\033[1;32m[*] ", end=""); print("                            [ Mebus | https://github.com/Mebus/]\r\n")
...
def version():
    ...
    print("\033[1;32m[*] ", end=""); print("	* Hacked up by j0rgan - j0rgan@remote-exploit.org")
    print("\033[1;32m[*] ", end=""); print("	* http://www.remote-exploit.org\r\n")
    print("\033[1;32m[*] ", end=""); print("	Take a look ./README.md file for more info about the program\r\n")
...
def improve_dictionary(file_to_open):
    ...
    print("\033[1;32m[*] ", end=""); print("\r\n      *************************************************")
    print("\033[1;32m[*] ", end=""); print("      *                    \033[1;31mWARNING!!!\033[1;m                 *")
    print("\033[1;32m[*] ", end=""); print("      *         Using large wordlists in some         *")
    print("\033[1;32m[*] ", end=""); print("      *       options bellow is NOT recommended!      *")
    print("\033[1;32m[*] ", end=""); print("      *************************************************\r\n")
    ...
    if conts == "y" and len(listic) > CONFIG["global"]["threshold"]:
        ...
        print("\033[1;32m[*] ", end=""); print("[-] Check configuration file for increasing this number.\r\n")
        conts = input(
            "> Do you want to concatenate all words from wordlist? Y/[N]: "
        ).lower()
    ...
    print("\033[1;32m[*] ", end=""); print("[+] Sorting list and removing duplicates...")
...
def interactive():
    ...
    print("\033[1;32m[*] ", end=""); print("[+] If you don't know all the info, just hit enter when asked! ;)\r\n")
...
def download_http(url, targetfile):
    print("\033[1;32m[*] ", end=""); print("[+] Downloading " + targetfile + " from " + url + " ... ")
...
def download_wordlist():
    ...
    print("\033[1;32m[*] ", end=""); print("     1   Moby            14      french          27      places")
    print("\033[1;32m[*] ", end=""); print("     2   afrikaans       15      german          28      polish")
    print("\033[1;32m[*] ", end=""); print("     3   american        16      hindi           29      random")
    print("\033[1;32m[*] ", end=""); print("     4   aussie          17      hungarian       30      religion")
    print("\033[1;32m[*] ", end=""); print("     5   chinese         18      italian         31      russian")
    print("\033[1;32m[*] ", end=""); print("     6   computer        19      japanese        32      science")
    print("\033[1;32m[*] ", end=""); print("     7   croatian        20      latin           33      spanish")
    print("\033[1;32m[*] ", end=""); print("     8   czech           21      literature      34      swahili")
    print("\033[1;32m[*] ", end=""); print("     9   danish          22      movieTV         35      swedish")
    print("\033[1;32m[*] ", end=""); print("    10   databases       23      music           36      turkish")
    print("\033[1;32m[*] ", end=""); print("    11   dictionaries    24      names           37      yiddish")
    print("\033[1;32m[*] ", end=""); print("    12   dutch           25      net             38      exit program")
    print("\033[1;32m[*] ", end=""); print("    13   finnish         26      norwegian       \r\n")
    print("\033[1;32m[*] ", end=""); print(
...
def download_wordlist_http(filedown):
    ...
    if intfiledown in arguments:
        ...
        print("\033[1;32m[*] ", end=""); print("[+] files saved to " + dire)

    else:
        print("\033[1;32m[*] ", end=""); print("[-] leaving.")
